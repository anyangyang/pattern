...
import interatorAndComposite.interator.demo2.interator.DinerMenuInterator;
import interatorAndComposite.interator.demo2.interator.Interator;
import interatorAndComposite.interator.demo2.interator.PancakeHouseMenuInterator;
...
public class PancakeHouseMenu {
    ...
    public Interator<MenuItem> createInterator() {
        return new PancakeHouseMenuInterator(menuItemList, menuItemList == null ? 0 : menuItemList.size());
    }
}
