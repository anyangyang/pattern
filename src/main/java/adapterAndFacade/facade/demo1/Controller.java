package adapterAndFacade.facade.demo1;

import adapterAndFacade.facade.demo1.command.Command;
import adapterAndFacade.facade.demo1.command.Projector.ProjectorOffCommand;
import adapterAndFacade.facade.demo1.command.Projector.ProjectorOnCommand;
import adapterAndFacade.facade.demo1.command.Projector.ProjectorSetInputCommand;
import adapterAndFacade.facade.demo1.command.Projector.ProjectorSetModeCommand;
import adapterAndFacade.facade.demo1.command.amplifier.AmplifierOffCommand;
import adapterAndFacade.facade.demo1.command.amplifier.AmplifierOnCommand;
import adapterAndFacade.facade.demo1.command.amplifier.AmplifierSetModeCommand;
import adapterAndFacade.facade.demo1.command.amplifier.AmplifierSetVolumeCommand;
import adapterAndFacade.facade.demo1.command.dvdPlayer.DvdPlayerOffCommand;
import adapterAndFacade.facade.demo1.command.dvdPlayer.DvdPlayerOnCommand;
import adapterAndFacade.facade.demo1.command.dvdPlayer.DvdPlayerPlayCommand;
import adapterAndFacade.facade.demo1.command.light.LightOffCommand;
import adapterAndFacade.facade.demo1.command.light.LightOnCommand;
import adapterAndFacade.facade.demo1.command.light.LightSetDimCommand;
import adapterAndFacade.facade.demo1.command.popcornPopper.PopcornPopperOffCommand;
import adapterAndFacade.facade.demo1.command.popcornPopper.PopcornPopperOnCommand;
import adapterAndFacade.facade.demo1.command.popcornPopper.PopcornPopperStartCommand;
import adapterAndFacade.facade.demo1.command.screen.ScreenDownCommand;
import adapterAndFacade.facade.demo1.command.screen.ScreenUpCommand;
import adapterAndFacade.facade.demo1.devices.*;
