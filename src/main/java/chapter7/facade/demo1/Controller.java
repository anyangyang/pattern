package chapter7.facade.demo1;

import chapter7.facade.demo1.command.Command;
import chapter7.facade.demo1.command.Projector.ProjectorOffCommand;
import chapter7.facade.demo1.command.Projector.ProjectorOnCommand;
import chapter7.facade.demo1.command.Projector.ProjectorSetInputCommand;
import chapter7.facade.demo1.command.Projector.ProjectorSetModeCommand;
import chapter7.facade.demo1.command.amplifier.AmplifierOffCommand;
import chapter7.facade.demo1.command.amplifier.AmplifierOnCommand;
import chapter7.facade.demo1.command.amplifier.AmplifierSetModeCommand;
import chapter7.facade.demo1.command.amplifier.AmplifierSetVolumeCommand;
import chapter7.facade.demo1.command.dvdPlayer.DvdPlayerOffCommand;
import chapter7.facade.demo1.command.dvdPlayer.DvdPlayerOnCommand;
import chapter7.facade.demo1.command.dvdPlayer.DvdPlayerPlayCommand;
import chapter7.facade.demo1.command.light.LightOffCommand;
import chapter7.facade.demo1.command.light.LightOnCommand;
import chapter7.facade.demo1.command.light.LightSetDimCommand;
import chapter7.facade.demo1.command.popcornPopper.PopcornPopperOffCommand;
import chapter7.facade.demo1.command.popcornPopper.PopcornPopperOnCommand;
import chapter7.facade.demo1.command.popcornPopper.PopcornPopperStartCommand;
import chapter7.facade.demo1.command.screen.ScreenDownCommand;
import chapter7.facade.demo1.command.screen.ScreenUpCommand;
import chapter7.facade.demo1.devices.*;
